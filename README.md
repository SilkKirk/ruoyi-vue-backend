...
* **ORM 框架**：MyBatis → **MyBatis-Flex**（v1.10.9），更轻量、更灵活。
* **工作流引擎**：新增 **ruoyi-workflow** 模块，集成 **Flowable 7.1.0** 工作流引擎，支持流程设计、审批流转等。
* **Spring Boot**：升级至 **3.5.14**，基于 JDK 17。
* **API 文档**：Swagger → **SpringDoc**（v2.8.17），更贴合 Spring Boot 3 生态。
